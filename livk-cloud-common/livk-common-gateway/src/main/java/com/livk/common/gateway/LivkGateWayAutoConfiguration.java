...
public class LivkGateWayAutoConfiguration {
    ...
    public RedisRouteHealthIndicator redisRouteHealthIndicator(LivkReactiveRedisTemplate livkReactiveRedisTemplate) throws Exception {
        ThrowException.isTrue(o -> Boolean.FALSE
                .equals(livkReactiveRedisTemplate.hasKey(LivkRedisRouteDefinitionRepository.ROUTE_KEY)
                        .block())).throwException(new RouteCheckException("route initialization not detected"));
