...
> [Gateway路由信息与Redis操作结合](livk-common/livk-common-gateway/src/main/java/com/livk/common/gateway/support/LivkRedisRouteDefinitionRepository.java).<br>
...
> [策略模式抽象类](./livk-cloud-common/livk-common-core/src/main/java/com/livk/common/core/handler/AbstractHandlerAdapter.java).<br>
> [ReactiveRedis配置](./livk-cloud-common/livk-common-redis/src/main/java/com/livk/common/redis/support/LivkReactiveRedisTemplate.java).<br>
